         ...
         <div className={No.nav}>
          <div className={No.navb}>
            ...
            <div
              ...
              <Link style={{ "--i": 1 }} className={No.lk} to="/Home">Home</Link>
              <Link style={{ "--i": 2 }} to='newsl' smooth={true} duration={800} className={No.lk} >Newsletter</Link>
              <Link style={{ "--i": 4 }} to='foot' smooth={true} duration={2000} className={No.lk}>Contact</Link>
           </div>
          </div>
        </div>
    </div>
