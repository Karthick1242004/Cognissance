...
function Techevent() {
  return (
    ...
    <div className={Eo.card}>
       ...
       <Link to='/paper' className={Eo.reg}> Click to register</Link>
       <div className={Eo.gocorner}>
       <Link to="/paper"><div className={Eo.goarrow}>→</div></Link>
       </div>
    </div>
    <div className={Eo.card}>
      <p className={Eo.cardtitle}>Mindcape</p>
      <p className={Eo.smalldesc}>
      ...
      <Link to="/mindscape" className={Eo.reg}>Click to register</Link>
      <div className={Eo.gocorner}>
      <Link to="/mindscape"><div className={Eo.goarrow}>→</div></Link>
      </div>
    </div>
    <div className={Eo.card}>
      ...
      <Link to='/reciprocal' className={Eo.reg}>Click to register</Link>
      <div className={Eo.gocorner}>
      <Link to="/reciprocal"><div className={Eo.goarrow}>→</div></Link>
      </div>
    </div>
    <div className={Eo.card}>
      ...
      <div className={Eo.gocorner}>
      <Link to="/bitrealm"><div className={Eo.goarrow}>→</div></Link>
      </div>
    </div>
    <div className={Eo.card}>
      ...
      <Link to='/bitwizard'className={Eo.reg} >Click to register</Link>
      <div className={Eo.gocorner}>
      <Link to="/bitwizard"><div className={Eo.goarrow}>→</div></Link>
      </div>
    </div>
  </div>
  </div>
